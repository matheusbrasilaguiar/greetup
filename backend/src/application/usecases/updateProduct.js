...
async function updateProduct({ id, name, description, category, subcategory, active, price, companyId }, { productRepository }) {
  if (!id) {
  ...
  const productEntity = Product.update({ name, description, category, subcategory, active });
